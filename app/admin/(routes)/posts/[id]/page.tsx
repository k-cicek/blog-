...
type EditPostForm = z.infer<typeof CreatePostSchema>;
...
const AdminPostEditPage = () => {
    ...
    useEffect(() => {
        async function load() {
            ...
            if (data.translations?.tr) setValue("translations.tr", data.translations.tr);
            if (data.translations?.en) setValue("translations.en", data.translations.en);
            setLoading(false);
        }
        load();
    }, [id, setValue])
